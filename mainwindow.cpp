    ...
    ui(new Ui::MainWindow)
{
    ...
    QPixmap pm("C:/Users/User/Downloads/Hotel_Management_in_QT/build-Hotel_Management_in_QT-Desktop_Qt_5_15_13_MinGW_64_bit-Debug/hotel.jpeg"); // <- path to image file
